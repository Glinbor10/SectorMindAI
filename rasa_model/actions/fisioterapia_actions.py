...
class ActionUrgenciaFisioterapia(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if tipo_negocio != "fisioterapia":
            dispatcher.utter_message(text="⚠️ Este negocio no ofrece servicios de fisioterapia. ¿En qué puedo ayudarte?")
            return []
